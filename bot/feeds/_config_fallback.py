...
_DEFAULTS = {
    ...
    # cf. bot/config.py pour la justification complète (correctif incident production
    # 2026-07-24T16 : Yahoo gratuit ne fournit quasi jamais de bid/ask exploitable).
